# Generated by Django 4.2.30 on 2026-05-04 05:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(1, 'To Do'), (2, 'In progress'), (3, 'Done')], default=1, max_length=1)),
                ...
                ('project_task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='task_management.projects')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='task_management.projects')),
